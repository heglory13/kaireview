...
# COPY --from=builder --chown=node:node /app/frontend/.next/cache ./.next/cache
...
# Next.js standalone output is nested under /app/frontend with the current turbopack root.
